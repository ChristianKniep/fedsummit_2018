...
1. From the main PWD screen click the `UCP` button on the left side of the screen
	...
	> **Note**: Because this is a lab-based install of Docker EE we are using the default self-signed certs your browser may display a security warning. It is safe to click through this warning.
	>
